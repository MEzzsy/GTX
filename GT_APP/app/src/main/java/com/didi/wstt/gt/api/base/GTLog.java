 ...
 */
package com.didi.wstt.gt.api.base;
...
public class GTLog {
     ...
     *
     * @param logFileName 之前在startLog方法中传入的文件名， 如文件名非法或未在startLog启动过，则直接返回
     */
