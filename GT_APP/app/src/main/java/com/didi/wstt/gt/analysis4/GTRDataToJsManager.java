...
public class GTRDataToJsManager {
    ...
    private static com.didi.wstt.gt.datatool.GTRAnalysis gtrAnalysis = null;
...
//        appendDataJs(stringBuilder.toString());
    ...
    public static com.didi.wstt.gt.datatool.GTRAnalysis getGTRAnalysis(String dataFilePath) throws Exception {
        File file = new File(dataFilePath);
        if (!file.exists()) {
            throw new Exception("dataFilePath is not exists:" + dataFilePath);
        } else {
            com.didi.wstt.gt.datatool.GTRAnalysis gtrAnalysis = new GTRAnalysis();
