 ...
 */
package com.didi.wstt.gt.plugin.tcpdump;

import android.content.Context;
import android.os.Bundle;

import com.didi.wstt.gt.GTApp;
import com.didi.wstt.gt.api.utils.CMDExecute;
import com.didi.wstt.gt.api.utils.Env;
import com.didi.wstt.gt.plugin.PluginTaskExecutor;
import com.didi.wstt.gt.utils.FileUtil;
import com.didi.wstt.gt.utils.RootUtil;
...
public class GTCaptureEngine implements PluginTaskExecutor {
     ...
     * @param needInputStream 是否需要输出抓包命令执行后返回的输入流
     */
